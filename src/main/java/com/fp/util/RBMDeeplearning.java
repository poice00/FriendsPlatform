...
public class RBMDeeplearning {
	...
	public RBMDeeplearning(int N, int n_visible, int n_hidden, 
	...
	private static void test_rbm() {
		...
		RBMDeeplearning rbm = new RBMDeeplearning(train_N, n_visible, n_hidden, null, null, null, rng);
